...
namespace Kata.Spec
{
    ...
    public class when_the_input_contains_new_line_and_comma_delimiters
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_user_input_contains_several_negative_numbers
    {
        ...
        It should_throw_an_exception_with_all_negatives = () => { _result.Message.Should().Be("negatives not allowed: -1, -4"); };
        static Calculator _systemUnderTest;
    ...
    public class when_the_user_input_contains_numbers_larger_than_1000
    {
        ...
        Because of = () => { _result = _systemUnderTest.Add("2,1,1001"); };

        It should_return_the_sum_of_the_numbers_less_than_1001 = () => { _result.Should().Be(3); };
        private static Calculator _systemUnderTest;
        private static int _result;
    }
    ...
    public class when_user_input_contains_multiple_numbers_with_multiple_custom_delimiters
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
