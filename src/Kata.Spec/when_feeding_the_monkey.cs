...
namespace Kata.Spec
{
    ...
    public class when_input_contains_one_negative_number
    {
        ...
        private It should_throw_an_exception = () => { _result.Message.Should().Be("negatives not allowed: -3"); };
        private static Calculator _systemUnderTest;
        private static Exception _result;
    }

    public class when_user_input_contains_several_negatives
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_input_contains_numbers_larger_than_1000
    {
        ...
        It should_sum_the_numbers_less_than_1001 = () => { _result.Should().Be(2); };
        private static Calculator _systemUnderTest;
        private static int _result;
    }
    ...
    public class when_input_is_multiple_numbers_with_multiple_custom_delimiters
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
